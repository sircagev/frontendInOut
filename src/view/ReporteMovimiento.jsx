...
const Movimientos = () => {
  ...
  const aplicarFiltros = (data) => {
    ...
    filteredData.sort((a, b) => new Date(b['Fecha del Prestamo']) - new Date(a['Fecha del Prestamo']));
    return filteredData;
  };
  ...
  return (
    <div className="container">
      <h1 className="text-center mb-4 mt-4 font-bold uppercase">Reporte de Movimientos</h1>
