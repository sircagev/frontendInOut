...
export const Prestamos = () => {
    ...
    return (
        <div className='w-full flex flex-col justify-center items-center'>
            ...
            <div className={`${selected !== 'solicitudes' ? "hidden" : ""} w-[80%] flex justify-center`}>
            ...
            <div className={`${selected !== 'En Prestamo' ? "hidden" : ""} w-full flex justify-center`}>
                <TableGeneral columns={columnsPrestamos} funcionListar={ListarMovimientosEnPrestamo} />
            </div>
            <div className={`${selected !== 'canceladas' ? "hidden" : ""} w-full flex justify-center`}>
                <TableGeneral columns={columnsPrestamos} funcionListar={ListarMovimientosCancelados} />
            </div>
        </div>
    )
}
