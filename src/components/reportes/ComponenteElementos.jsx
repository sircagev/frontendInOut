  ...
  const data = useMemo(() => {
    ...
    if (searchPerformed) {
      filteredData = filteredData.filter((row) => {
        ...
        const rowFechaIngreso = convertDateFormat(row.created_at);
        const dateMatches = (!startDate || (rowFechaIngreso && rowFechaIngreso >= startDate)) &&
                            (!endDate || (rowFechaIngreso && rowFechaIngreso <= endDate));
