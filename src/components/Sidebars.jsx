...
const Sidebars = () => {
    ...
    return (
        <div className={`flex flex-col items-center h-full overflow-hidden text-gray-400 bg-gray-900 rounded-s transition-all ${isHover ? 'w-40 duration-700 ' : ' w-16 duration-500'}`}
            ...
            <a className={`flex items-center ${isHover ? 'w-full px-3' : 'justify-center'} mt-3 h-12`} href="#">
                ...
                {isHover && <span className="ml-2 text-sm font-bold">The App</span>}
            </a>
